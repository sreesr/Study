...
"""autogenerated by genpy from sreesr_pkg/AddTwoIntsRequest.msg. Do not edit."""
import sys
...
class AddTwoIntsRequest(genpy.Message):
  ...
  _type = "sreesr_pkg/AddTwoIntsRequest"
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from sreesr_pkg/AddTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AddTwoIntsResponse(genpy.Message):
  ...
  _type = "sreesr_pkg/AddTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
