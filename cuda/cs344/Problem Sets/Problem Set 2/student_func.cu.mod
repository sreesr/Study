                   ...
                   const float* const filter, const int filterWidth)
{
  ...
  int pos = absolute_image_position_y * numCols + absolute_image_position_y;
  ...
  //outputChannel[pos] = inputChannel[pos];
                      ...
                      unsigned char* const blueChannel)
{
  ...
  //printf("(%d, %d) ", absolute_image_position_x, absolute_image_position_y);
  if (absolute_image_position_x > max_x) { 
      max_x = absolute_image_position_x;
      //printf("(%d, %d) ", max_x, max_y);
  }
  if (absolute_image_position_y > max_y) {
      max_y = absolute_image_position_y;
      //printf("(%d, %d) ", max_x, max_y);
  }
  //
  // NOTE: Be careful not to try to access memory that is outside the bounds of
  ...
  redChannel[pos] = inputImageRGBA[pos].x;
  greenChannel[pos] = inputImageRGBA[pos].y;
  blueChannel[pos] = inputImageRGBA[pos].z;
                                ...
                                const float* const h_filter, const size_t filterWidth)
{
  ...
  checkCudaErrors(cudaMalloc(&d_filter, filterWidth * filterWidth));
                        ...
                        const int filterWidth)
{
  ...
  gaussian_blur<<<numRows, numCols>>>(d_red, d_redBlurred, numRows, numCols, d_filter, filterWidth);
  gaussian_blur<<<numRows, numCols>>>(d_green, d_greenBlurred, numRows, numCols, d_filter, filterWidth);
  gaussian_blur<<<numRows, numCols>>>(d_blue, d_blueBlurred, numRows, numCols, d_filter, filterWidth);
